...
\textbf{Social and technical support structures for community science and civic engagement.} Digital labor, sensor journalism, citizen science, crowd-sourcing, community science, power relations in knowledge commons, cooperation, network analysis, civic engagement through the humanities, social and cognitive ergonomics, hydrology, sanitation
...
\begin{innerlist}
\item Work on the \href{http://www.raspberrypi.org/}{Raspberry Pi} based \href{http://publiclab.org/tag/fido}{Fido} and \href{Open Pipe Kit}{http://publiclab.org/wiki/open-pipe-kit} interfaces for air and water quality monitors
\item Work on web and sensor technology for agriculture-focused monitoring devices
\end{innerlist}
...
\item \href{http://pvos.org/openscience-publiclab-leitzel/#/}{``Open Science and Public Lab"}, \href{http://leitzelcenter.unh.edu/}{Leitzel Center for Mathematics, Science, and Engineering}, \href{http://unh.edu}{University of New Hampshire}.

\item \href{http://publiclab.org/notes/donblair/08-14-2014/epa-s-advanced-monitoring-tech-demo-day}{"The Riffle: an Open Source Hardware Water Quality Monitor"}, \emph{Next Generation Compliance Advanced Monitoring Tech Demo Day}, U.S. Environmental Protection Agency, Washington D.C.
